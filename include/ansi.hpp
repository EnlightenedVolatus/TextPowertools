...
namespace TextPowertools {
    ...
    inline void ansiForegroundColor(int r, int g, int b) {
        std::cout << "\x1b[38;2;" << r << ';' << g << ';' << b << 'm';
    }


    inline void ansiForegroundColor(ANSI_COLOR color) {
        std::cout << "\x1b[" << color << 'm';
    }


    inline void ansiBackgroundColor(int r, int g, int b) {
        std::cout << "\x1b[48;2;" << r << ';' << g << ';' << b << 'm';
    }


    inline void ansiBackgroundColor(ANSI_COLOR color) {
        std::cout << "\x1b[" << color + 10 << 'm';
    }


    inline void ansiResetForeground() {
        std::cout << "\x1b[39m";
    }


    inline void ansiResetBackground() {
        std::cout << "\x1b[49m";
    }


    inline void ansiResetColor() {
        std::cout << "\x1b[39;49m";
    }


    inline void ansiResetWeight() {
        std::cout << "\x1b[22m";
    }


    inline void ansiResetStyle() {
        std::cout << "\x1b[23m";
    }
